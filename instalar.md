...
No necesitas saber programar. Elige uno de los dos caminos.

## Primero: baja el material

1. Entra a la página del repositorio en GitHub.
2. Botón verde **Code** → **Download ZIP**.
3. Descomprime el archivo en tu computadora.

Ya tienes dos cosas: la carpeta `cerebro_ejemplo/` y la carpeta `skills/`.
...
1. En la app de Claude, entra a **Configuración**.
2. Busca la sección de **capacidades** o **skills**.
3. Sube cada carpeta de `skills/` como un archivo `.zip` aparte. Una skill, un zip.
4. Después las invocas por su nombre dentro del chat.

Si no encuentras esa sección, tu plan no la incluye todavía. Usa el Camino A, que da el mismo resultado.

---

## Comprueba que quedó

Escríbele esto a tu proyecto:
